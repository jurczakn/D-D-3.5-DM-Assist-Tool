...
Barbarian::Barbarian(string n, string r, string a, string d, int l, int s, int age, char gender, double ht, string e, string h, string skin)
	...
	speed = 40;//set base speed

	raceAdj();//adjust scores and speed by race

	//have user place character scores
	cout << "Now please choose where you will place each ability score.\nRemember, for a Barbarian, strength is of the most importance, \nbut constitution, dex, and wisdom are also important." << endl

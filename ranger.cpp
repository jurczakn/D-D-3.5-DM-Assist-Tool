...
Ranger::Ranger(string n, string r, string a, string d, int l, int s, int age, char gender, double ht, string e, string h, string skin)
	...
	cout << "Now please choose where you will place each ability score.\nRemember, for a Ranger, dexterity is of the most importance, \nbut strength, and wisdom are also important." << endl
